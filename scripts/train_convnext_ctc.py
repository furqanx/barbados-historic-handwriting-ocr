"""Train ConvNeXt-tiny + BiLSTM + CTC."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--backbone-name", default="convnext_tiny")
...
def main() -> None:
    args = parse_args()
    run_name = args.run_name or f"convnext_ctc_fold{args.fold}"
    ...
    _, best_score = train_convnext_ctc(
        train_manifest,
        tokenizer,
        config=config,
