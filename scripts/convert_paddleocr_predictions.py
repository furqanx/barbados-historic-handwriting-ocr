"""Convert PaddleOCR recognition output to prediction and submission CSV."""
...
from src.paddleocr_rec.prediction_parser import (  # noqa: E402
...
def main() -> None:
    args = parse_args()
    predictions = load_paddleocr_prediction_file(args.raw_output)
