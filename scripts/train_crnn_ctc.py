"""Train the custom CRNN-BiLSTM-CTC baseline."""
...
from src.training.ctc_trainer import CTCTrainingConfig, train_crnn_ctc  # noqa: E402
...
def main() -> None:
    args = parse_args()
    run_name = args.run_name or f"crnn_ctc_fold{args.fold}"
